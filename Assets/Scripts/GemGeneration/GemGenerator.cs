...
public class GemGenerator : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("The list of the data on small gems generated.")] private List<GemData> m_smallGems = new List<GemData>();
    public List<GemData> smallGems => m_smallGems;
    [SerializeField, Tooltip("The destination gem generated")]  private GemData m_destinationGem;
    public GemData destinationGem => m_destinationGem;
    ...
    public void GenerateSmallGems() {
        ...
        for(int i = 0; i < m_maxSmallGems; i++) {
            ...
            m_smallGems.Add(newGem);

            // Add a point on the held map via m_terrainGenerator
    ...
    public void GenerateDestinationGem(Vector3 destination) {
        ...
        // Instantiate
        Gem generatedGem = Instantiate(m_destinationGemPrefab, pos, rot, m_gemParent) as Gem;

        // Save
        m_destinationGem = new GemData { 
            gem=generatedGem, 
            id=m_smallGems.Count,
            position=pos,
            detected=false,
            collected=false,
            isDestination=true
